...
for targets in ./input_seq/*.txt; do
	...
	python run_prediction.py --targets ${targname}/inputs/target.tsv --outfile_prefix ${targname}/outfile --model_names model_2_ptm_ft --model_params_files /mnt/isilon/sgourakis_lab_storage/persona/sagar/afft_hla3db/params/7WKJ_af_mhc_params_2351.pkl  --ignore_identities
